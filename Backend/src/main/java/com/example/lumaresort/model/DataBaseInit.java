...
public class DataBaseInit implements ApplicationRunner {
    ...
    @Autowired
    private com.example.lumaresort.repository.OfertaFlashRepository ofertaFlashRepository;
...
public class Operador {
 ...
 /*
        ...
        //Crear 8 premios predefinidos 
        Premio premio1 = new Premio(
                "Late Check-out",
                "Disfruta hasta las 3 PM sin cargo adicional",
                "#FF6B6B",
                "🕐"
        );
        ...
        Premio premio3 = new Premio(
                "Descuento 20% en Spa",
                "Relájate con nuestros tratamientos",
                "#95E1D3",
                "💆"
        );
        ...
        premioRepository.save(premio3);
        premioRepository.save(premio4);
        premioRepository.save(premio5);
        premioRepository.save(premio6);
        premioRepository.save(premio7);
        premioRepository.save(premio8);
