...
public class ServicioRepository {
    ...
    public void initFakeData() {
        ...
        servicios.put(1, new Servicio(1, "Aseo y mantenimiento de la habitación", "Servicio que incluye la limpieza de la habitación, la limpieza de las botellas, el cambio de sában y el mantenimiento de los electrodomésticos", 10, "https://americandreamsinvest.com/wp-content/uploads/2024/08/full-shot-people-cleaning-office4.jpg", lista1, null));
        ...
        servicios.put(6, new Servicio(6, "Acceso a la sauna", "Puede acceder a la sauna durante las horas de apertura del complejo", 70, "https://ark-architects.com/wp-content/uploads/2022/05/IMG_0263-2048x1536-1.jpeg", lista1, null));
